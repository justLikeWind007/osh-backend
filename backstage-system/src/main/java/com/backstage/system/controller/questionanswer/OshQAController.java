...
public class OshQAController {
    ...
    @OshUserEvent(module = "答疑模块", actionType = "新增", description = "新增问题")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "新增", description = "发布问题")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "查询", description = "我的草稿")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "编辑", description = "编辑问题")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "删除", description = "删除问题")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "关注", description = "关注问题")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "取消关注", description = "取消关注问题")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "查询", description = "问题列表")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "新增", description = "回答")
    ...
    @OshUserEvent(module = "答疑模块", actionType = " 修改", description = "采纳回答")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "修改", description = "取消采纳回答")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "查询", description = "查询问题详情")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "点赞", description = "给回答点赞")
    ...
    @OshUserEvent(module = "答疑模块", actionType = "取消点赞", description = "取消给回答点赞")
