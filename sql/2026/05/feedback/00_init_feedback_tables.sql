...
VALUES
('course-design', '课程设计', 1, '课程模块中的设计类反馈'),
('course-player', '课程播放器', 2, '播放器与观看体验相关反馈'),
('course-content', '课程内容', 3, '课程内容质量与结构相关反馈'),
('exam-module', '考试模块', 4, '考试、测验、提交相关反馈'),
('community-module', '社区互动', 5, '评论、讨论、互动相关反馈'),
('ui-experience', '界面体验', 6, '页面布局、交互体验相关反馈')
ON DUPLICATE KEY UPDATE
    `name` = VALUES(`name`),
    `sort_order` = VALUES(`sort_order`),
